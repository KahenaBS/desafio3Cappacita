...
function curarPokemon(id) {
    ...
    pokemonferido.hp = pokemonferido.hp + pocao

    if(pokemonferido.hp > 100) pokemonferido.hp = 100
...
module.exports = {
    salvarPokemons, mostrarPokemon, mostrarPokemons, atualizarPokemon, deletarPokemon, batalhaPokemon, curarPokemon
}